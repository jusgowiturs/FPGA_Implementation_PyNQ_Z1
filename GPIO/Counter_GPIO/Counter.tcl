...
\
  ...
  connect_bd_net -net Clock_Divider_0_clock_out [get_bd_pins Clock_Divider_0/clock_out] [get_bd_pins counter_0/clkpulse]
  connect_bd_net -net counter_0_led [get_bd_ports led] [get_bd_pins counter_0/led]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Clock_Divider_0/reset] [get_bd_pins counter_0/rst] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
