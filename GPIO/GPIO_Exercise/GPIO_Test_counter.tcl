...
\
  ...
  # Create instance: toggle_LED_using_clo_0, and set properties
  set block_name toggle_LED_using_clock
  set block_cell_name toggle_LED_using_clo_0
  if { [catch {set toggle_LED_using_clo_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $toggle_LED_using_clo_0 eq "" } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins toggle_LED_using_clo_0/clk]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins toggle_LED_using_clo_0/reset]
  connect_bd_net -net toggle_LED_using_clo_0_led [get_bd_ports led] [get_bd_pins processing_system7_0/GPIO_I] [get_bd_pins toggle_LED_using_clo_0/led]
