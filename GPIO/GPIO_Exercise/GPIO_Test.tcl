...
proc create_root_design { parentCell } {
  ...
  set F2 [ create_bd_port -dir O F2 ]
  set F3 [ create_bd_port -dir O F3 ]
  set F4 [ create_bd_port -dir O F4 ]
  set SW [ create_bd_port -dir I SW ]

  # Create instance: A, and set properties
  set A [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 A ]
  ...
  # Create instance: GPIO_IO_LogicalOpera_0, and set properties
  set block_name GPIO_IO_LogicalOperation
  set block_cell_name GPIO_IO_LogicalOpera_0
  if { [catch {set GPIO_IO_LogicalOpera_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $GPIO_IO_LogicalOpera_0 eq "" } {
...
\
  ...
  connect_bd_net -net A_Dout [get_bd_pins A/Dout] [get_bd_pins GPIO_IO_LogicalOpera_0/A]
  connect_bd_net -net B_Dout [get_bd_pins B/Dout] [get_bd_pins GPIO_IO_LogicalOpera_0/B]
  connect_bd_net -net GPIO_IO_LogicalOpera_0_F1 [get_bd_ports F1] [get_bd_pins GPIO_IO_LogicalOpera_0/F1] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net GPIO_IO_LogicalOpera_0_F2 [get_bd_ports F2] [get_bd_pins GPIO_IO_LogicalOpera_0/F2] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net GPIO_IO_LogicalOpera_0_F3 [get_bd_ports F3] [get_bd_pins GPIO_IO_LogicalOpera_0/F3] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net GPIO_IO_LogicalOpera_0_F4 [get_bd_ports F4] [get_bd_pins GPIO_IO_LogicalOpera_0/F4] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net SW_0_1 [get_bd_ports SW] [get_bd_pins GPIO_IO_LogicalOpera_0/SW]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins A/Din] [get_bd_pins B/Din] [get_bd_pins processing_system7_0/GPIO_O]
