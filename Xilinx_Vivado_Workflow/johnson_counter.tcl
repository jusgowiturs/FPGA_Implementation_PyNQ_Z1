...
proc create_root_design { parentCell } {
  ...
  # Create instance: goLeft, and set properties
  set goLeft [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 goLeft ]

  # Create instance: goRight, and set properties
  set goRight [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 goRight ]
...
\
  ...
  connect_bd_net -net goLeft_Dout [get_bd_pins goLeft/Dout] [get_bd_pins jc2_0/goLeft]
  connect_bd_net -net goRight_Dout [get_bd_pins goRight/Dout] [get_bd_pins jc2_0/goRight]
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins goLeft/Din] [get_bd_pins goRight/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins stop/Din]
