...
HD_PWD='D:/project_1_vio_understanding/project_1_vio_understanding.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_vio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_vio.tcl -notrace
