...
HD_PWD='D:/project_1_vio_understanding/project_1_vio_understanding.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_vio.tcl
